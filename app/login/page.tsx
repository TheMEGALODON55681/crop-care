...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Authentication is part of the planned roadmap (see README).
    // No credentials are sent anywhere — this is a demo project.
    setStatus('pending');
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to your agricultural dashboard</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {status === 'info' && (
                <p className="mt-3 text-sm text-center text-gray-600 bg-green-50 border border-green-100 rounded-md py-2 px-3">
                  Authentication is on the roadmap. This is a demo build —
